...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("undo", "Remove the last N user turns (default: 1)", "Session",
               args_hint="[count]"),
    CommandDef("turns", "List selectable user turns for undo/resume-turn", "Session",
               args_hint="[count]"),
    CommandDef("resume-turn", "Truncate history to before a specific user turn", "Session",
               aliases=("rt",), args_hint="<turn_number>"),
